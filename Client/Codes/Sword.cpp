...
{
#ifndef _FINAL
	Tag(L"CSword", std::bind(&CSword::Debug_Render, this));
#endif
...
HRESULT CSword::Ready_Component(void)
{
	...
	// For.Mesh
	pComponent = m_pMeshCom = (Engine::CMesh_Static*)CComponent_Manager::GetInstance()->Clone_Component(SCENE_STATIC, L"CMesh_Static_Sword");
	if (nullptr == pComponent)
		return E_FAIL;
...
void CSword::Collision_ToStone(void)
{
...
#ifndef _FINAL
void CSword::Debug_Render()
{
	CDebug::GetInstance()->Add_DebugText("CSword");

}
#endif
_ulong CSword::Free(void)
{
	_ulong		dwRefCnt = 0;
