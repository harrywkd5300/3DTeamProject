...
{
#ifndef _FINAL
	Tag(L"CStaff", std::bind(&CStaff::Debug_Render, this));
#endif
...
HRESULT CStaff::Ready_Component(void)
{
	...
	// For.Mesh
	pComponent = m_pMeshCom = (Engine::CMesh_Static*)CComponent_Manager::GetInstance()->Clone_Component(SCENE_STATIC, L"CMesh_Static_Staff");
	if (nullptr == pComponent)
		return E_FAIL;
...
void CStaff::Collision_ToStone(void)
{
...
#ifndef _FINAL
void CStaff::Debug_Render()
{
	CDebug::GetInstance()->Add_DebugText("CStaff");

}
#endif
_ulong CStaff::Free(void)
{
	_ulong		dwRefCnt = 0;
