...
class CBigThug final : public CMonster
{
private:
	enum { BigThugColGroup_Hit, BigThugColGroup_Attack, BigThugColGroup_End };
	enum eBigThugAtk { BigThug_Defalut_Atk, BigThug_Swing_Atk, BigThug_Jump_Atk };

private:
	explicit CBigThug(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CBigThug() = default;
...
public:
	static CBigThug* Create(LPDIRECT3DDEVICE9 pGraphicDev);
...
protected:
	...
	// 멤버 변수
private:
	_int	m_iAtk_Count = BigThug_Defalut_Atk;
