...
HRESULT CUI_Stats::SetUp_CPConstantTable(LPD3DXEFFECT pEffect)
{
	...
	_float fMin = 0.f;
	_float fRatio = m_pObserver->Get_Current_CharInfo()->m_iMaxCp / 3.f;
	_float fCur = m_pObserver->Get_Current_CharInfo()->m_iCurCp - fMin;
...
HRESULT CUI_Stats::SetUp_CP1ConstantTable(LPD3DXEFFECT pEffect)
{
	...
	_float fMin = m_pObserver->Get_Current_CharInfo()->m_iMaxCp / 3.f;
	_float fRatio = m_pObserver->Get_Current_CharInfo()->m_iMaxCp / 3.f;
	_float fCur = m_pObserver->Get_Current_CharInfo()->m_iCurCp - fMin;
...
HRESULT CUI_Stats::SetUp_CP2ConstantTable(LPD3DXEFFECT pEffect)
{
	...
	//	
	_float fMin = m_pObserver->Get_Current_CharInfo()->m_iMaxCp / 3.f * 2.f;
	_float fRatio = m_pObserver->Get_Current_CharInfo()->m_iMaxCp /3.f;
	_float fCur = m_pObserver->Get_Current_CharInfo()->m_iCurCp - fMin;
