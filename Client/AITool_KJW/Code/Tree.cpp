...
{
#ifndef _FINAL
	Tag(L"CTree", std::bind(&CTree::Debug_Render, this));
#endif
...
HRESULT CTree::Ready_GameObject(void)
{
	...
	m_pTransformCom->Set_Infomation(CTransform::INFO_POSITION, &_vec3(10.f, 0.f, 10.f));
...
HRESULT CTree::Ready_Component(void)
{
	...
	// For.Mesh
	pComponent = m_pMeshCom = (Engine::CMesh_Static*)CComponent_Manager::GetInstance()->Clone_Component(SCENE_STAGE, L"CMesh_Static_Tree");
	if (nullptr == pComponent)
		return E_FAIL;
...
void CTree::Move_OnTerrain(void)
{
...
#ifndef _FINAL
void CTree::Debug_Render()
{
	CDebug::GetInstance()->Add_DebugText("CTree");

}
#endif

_ulong CTree::Free(void)
{
	_ulong		dwRefCnt = 0;
